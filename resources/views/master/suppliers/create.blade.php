            ...
            <div class="card-body p-4">
                <form action="{{ isset($supplier) ? route('suppliers.update', $supplier->id) : route('suppliers.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="form-floating">
                                <textarea name="address" id="address" class="form-control" style="height: 100px">{{ old('address', $supplier->address ?? '') }}</textarea>
                                <label for="address">Alamat Lengkap</label>
                            </div>
                        </div>
                        <div class="col-12 mt-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="is_active" name="is_active" {{ old('is_active', $supplier->is_active ?? true) ? 'checked' : '' }}>
