...
@section('title', 'Invoice Pembelian (AP)')

@section('actions')
<a href="{{ route('ap.invoices.create') }}" class="btn btn-fs-primary">
    <i class="fa-solid fa-plus"></i> Catat Invoice Supplier
</a>
@endsection
            ...
            <table class="table table-fs mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="{{ \Carbon\Carbon::parse($inv->due_date)->isPast() && $inv->status != 'paid' ? 'text-danger fw-bold' : '' }}">
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center py-4 text-muted">Belum ada invoice pembelian / hutang.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
